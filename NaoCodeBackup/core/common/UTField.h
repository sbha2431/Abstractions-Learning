...
const Point2D landmarkLocation[] = {
  ...
  Point2D(-FIELD_X+1000.0, HALF_FIELD_Y),       //  WO_BEACON_BLUE_YELLOW
  Point2D(-FIELD_X+1000.0, -HALF_FIELD_Y),      //  WO_BEACON_YELLOW_BLUE,
  Point2D(-FIELD_X, HALF_FIELD_Y),                  //  WO_BEACON_BLUE_PINK
  Point2D(-FIELD_X, -HALF_FIELD_Y),                  //  WO_BEACON_PINK_BLUE
  Point2D(-FIELD_X, 550.0),      //  WO_BEACON_PINK_YELLOW
  Point2D(-FIELD_X, -550.0),     //  WO_BEACON_YELLOW_PINK,

  Point2D( -FIELD_X-40.0, 0),                 // WO_OWN_GOAL
  Point2D( FIELD_X, 0 ),                 // WO_OPP_GOAL

  Point2D( -FIELD_X , -GOAL_Y / 2),       // WO_OWN_LEFT_GOALPOST
  Point2D( FIELD_X , GOAL_Y / 2 ),        // WO_OPP_LEFT_GOALPOST

  Point2D( -FIELD_X, GOAL_Y / 2),        // WO_OWN_RIGHT_GOALPOST
  Point2D( FIELD_X, -GOAL_Y / 2)         // WO_OPP_RIGHT_GOALPOST
};
