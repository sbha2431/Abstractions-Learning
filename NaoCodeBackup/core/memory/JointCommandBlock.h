...
DECLARE_INTERNAL_SCHEMA(struct JointCommandBlock : public MemoryBlock {
  public:
    ...
    void setLShoulderRoll(float target, float time, bool is_change, float stiff=1.0) {
      send_body_angles_ = true;
      angles_[LShoulderRoll] = target;
      body_angle_time_ = time;
      stiffness_[LShoulderRoll] = stiff;
    }

    void setRShoulderRoll(float target, float time, bool is_change, float stiff=1.0) {
      send_body_angles_ = true;
      angles_[RShoulderRoll] = target;
      body_angle_time_ = time;
      stiffness_[RShoulderRoll] = stiff;
    }

    void setLShoulderPitch(float target, float time, bool is_change, float stiff=1.0) {
      send_body_angles_ = true;
      angles_[LShoulderRoll] = target;
      body_angle_time_ = time;
      stiffness_[LShoulderPitch] = stiff;
    }

    void setRShoulderPitch(float target, float time, bool is_change, float stiff=1.0) {
      send_body_angles_ = true;
      angles_[RShoulderPitch] = target;
      body_angle_time_ = time;
      stiffness_[RShoulderPitch] = stiff;
    }

    void setBShoulderPitch(float target, float time, bool is_change, float stiff=1.0) {
      send_body_angles_ = true;
      angles_[RShoulderPitch] = target;
      angles_[LShoulderPitch] = target;
      body_angle_time_ = time;
      stiffness_[RShoulderPitch] = stiff;
      stiffness_[LShoulderPitch] = stiff;
    }
