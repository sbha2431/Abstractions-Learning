...
class Playing(StateMachine):
    ...
    class Stable(Node):
        def run(self):
            commands.stand()
            if self.getTime() > 0.5:
                # memory.speech.say("Suda you suck")
                self.finish()
    ...
    class Diagnostic(Node):
        ...
        def run(self):
            ...
            if ball.seen:
                print("Ball at ",ball.imageCenterX,", ",ball.imageCenterY,"Bearing ",ball.visionBearing)
            if goal.seen:
    ...
    def setup(self):
        ...
        #self.trans(stand,C)
            ...
            #print("a")
        # self.trans(stand,C,diag,T(60.0),sit,C,off)    
        # self.trans(stand,C,crc,C,app,C,sit,C,off)
        # self.trans(stand,C,app,C,self.Kick(),C,sit,C,off)
